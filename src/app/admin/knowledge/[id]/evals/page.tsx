...
export default function KnowledgeEvalDetailPage() {
  const params =
    useParams<{
      id:
        string;
    ...
    useCallback(
      async () => {
        ...
        try {
          const response =
            await fetch(
              `/api/admin/knowledge/${knowledgeId}/eval-detail`,
              {
                cache:
                  "no-store",
              }
      ...
      <section className="rounded-3xl border border-slate-200 bg-white p-5 shadow-sm sm:p-6">
        ...
        <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            ...
            {detail && (
              <div className="mt-3 flex flex-wrap gap-2 text-[10px]">
                ...
                {detail
                  .knowledge
                  .topicName && (
                  <span className="rounded-full bg-indigo-50 px-2.5 py-1 font-black text-indigo-700">
                    {
                      detail
                        .knowledge
                        .topicName
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <Link
              href={`/admin/knowledge/${knowledgeId}/edit`}
        ...
        <>
          ...
          <section className="grid gap-4 xl:grid-cols-2">
            ...
            <BatchCard
              ...
              emptyText="برای این Knowledge هنوز Auto Run ثبت نشده است."
              current
            />
          ...
          {detail
            ...
            <div className="rounded-2xl border border-amber-200 bg-amber-50 px-4 py-3 text-xs font-bold leading-6 text-amber-800">
              تعداد Golden Caseهای مرتبط بیشتر از سقف Auto Test بوده است؛ فقط بخشی از Caseهای مرتبط اجرا شده‌اند. برای بررسی کامل، از Test Center یک Run کامل اجرا کنید.
            </div>
          )}
          ...
          <section className="rounded-3xl border border-slate-200 bg-white shadow-sm">
            ...
            <div className="border-b border-slate-100 px-5 py-5 sm:px-6">
              ...
              <h2 className="text-lg font-black text-slate-950">
                نتیجه Golden Questionها
              </h2>

              <p className="mt-1 text-xs leading-6 text-slate-400">
                Regressionها و ERRORها در ابتدای فهرست نمایش داده می‌شوند.
              </p>
            ...
            <div className="space-y-4 p-4 sm:p-6">
              ...
              0 ? (
                ...
                <div className="rounded-2xl border border-dashed border-slate-200 bg-slate-50 px-4 py-12 text-center text-sm font-bold text-slate-400">
                  هنوز Run قابل مقایسه‌ای برای این Knowledge وجود ندارد.
                </div>
              )}
  ...
  return (
    ...
    >
      ...
      {run.latencyMs !==
        ...
        <p
          dir="ltr"
          className="mt-3 text-left font-mono text-[9px] text-slate-400"
        >
          {
            run.latencyMs
              .toLocaleString(
